...
export default function Sidebar({ isOpen = true, onClose }) {
  ...
  return (
    <nav
      ...
      className={cn(
        "w-64 h-screen bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col fixed left-0 top-0 z-50 transform transition-transform duration-300 ease-out",
